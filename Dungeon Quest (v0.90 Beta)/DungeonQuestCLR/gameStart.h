...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// licenseKey
			// 
			this->licenseKey->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 8.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->licenseKey->Location = System::Drawing::Point(191, 430);
			this->licenseKey->Name = L"licenseKey";
			this->licenseKey->PasswordChar = '*';
...
#pragma endregion
	...
	public: System::Void newGameChar_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		else
		{
			...
			int userLicenseKey;
			int userCheatCode;
			userLicenseKey = __int32::Parse(licenseKey->Text);
			if (userLicenseKey != gameKeyDev)
			{
				userCheatCode = __int32::Parse(licenseKey->Text);
				if (userCheatCode == cheatCode)
				{
					if (textName->Text->Length == 0)
					{
						System::Windows::Forms::DialogResult dialogResult = MessageBox::Show("Введите имя!", "Ошибка!", MessageBoxButtons::RetryCancel);
						gameStart::Show();
					}
					else
					{
...
private: System::Void textName_TextChanged(System::Object^ sender, System::EventArgs^ e)
	{
		...
		GlobalClass::playerName = textName->Text;
	}
