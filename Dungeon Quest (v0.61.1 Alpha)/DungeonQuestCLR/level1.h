...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Location = System::Drawing::Point(187, 136);
			...
			this->locationName1->BackColor = System::Drawing::Color::Transparent;
			...
			// textWindow1
			// 
			this->textWindow1->Location = System::Drawing::Point(367, 9);
			this->textWindow1->Name = L"textWindow1";
			this->textWindow1->Size = System::Drawing::Size(318, 362);
			this->textWindow1->TabIndex = 3;
			this->textWindow1->TextAlign = System::Drawing::ContentAlignment::BottomLeft;
			this->textWindow1->Click += gcnew System::EventHandler(this, &level1::textWindow1_Click);
			// 
			// choice1
			// 
			this->choice1->Location = System::Drawing::Point(20, 136);
			...
			// choice2
			// 
			this->choice2->Location = System::Drawing::Point(20, 183);
			...
			// choice3
			// 
			this->choice3->Location = System::Drawing::Point(20, 232);
			...
			// choice4
			// 
			this->choice4->Location = System::Drawing::Point(20, 285);
			...
			this->Name = L"level1";
			this->Text = L"Dungeon Quest (v0.61 Alpha)";
...
{
	textWindow1->Text = "В полумраке вы едва различаете, что видите. Здесь слишком темно, чтобы осмотреться лучше...";
	this->choice1->Text = L"Подойти к двери";
}
...
private: System::Void helpButton_Click(System::Object^ sender, System::EventArgs^ e)
{
	...
	"Слева от иконки находятся варианты действий персонажа, результаты которых будут отбражаться на текстовом поле. На этом пока всё. Удачи!", "Помощь", MessageBoxButtons::OK);
	level1::Show();
}
};
}
