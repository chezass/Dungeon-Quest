...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textName
			// 
			this->textName->Location = System::Drawing::Point(136, 132);
			...
			// textAge
			// 
			this->textAge->Location = System::Drawing::Point(136, 174);
			...
			// textAns
			// 
			this->textAns->Location = System::Drawing::Point(136, 218);
			...
			// newGameChar
			// 
			this->newGameChar->Location = System::Drawing::Point(367, 174);
			...
			// newGameExit
			// 
			this->newGameExit->Location = System::Drawing::Point(487, 379);
			...
			// licenseKey
			// 
			this->licenseKey->Location = System::Drawing::Point(196, 377);
			...
			this->ClientSize = System::Drawing::Size(574, 414);
